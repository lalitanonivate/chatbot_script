      ...
      <section class="widget" id="widget" role="dialog" aria-modal="true" aria-label="Chat and contact">
        ...
        <div class="page active" id="page-chat">
          ...
          <div class="composer">
            ...
            <button class="mic" id="mic" aria-label="Voice Input" type="button" style="margin-right: 8px;" title="Click to use voice input. Your browser will ask for permission the first time.">
