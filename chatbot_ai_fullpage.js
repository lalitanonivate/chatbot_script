  ...
  <div class="contact-wrap">
    ...
    <div class="field">
      ...
      <div class="chips" id="budget">
        <button class="chip" type="button" data-value="$10â€“50k">$10â€“50k</button>
        <button class="chip" type="button" data-value="$50â€“100k">$50â€“100k</button>
      ...
      openBtn.addEventListener("click", () => {
        ...
        if (!hasMessages) {
          ...
          if (previousMessages.length > 0) {
            ...
            setTimeout(() => addMsg(`Hi there! My name is ${botName} ðŸ‘‹. How can I help today?`, "bot"), 200);
          }
        ...
        saveUserInfo.addEventListener("click", () => {
          ...
          setTimeout(() => {
            ...
            if (savedUsername === username && savedEmail === email) {
              console.log('âœ… User data saved and verified successfully!');
            } else {
              console.log('âŒ User data verification failed!');
            }
          }, 100);
