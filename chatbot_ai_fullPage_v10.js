 (() => {
      ...
      /* Chat page */
      #widget .chat-header{ padding: 35px 20px 8px; font-weight: 700; font-size: 32px; background: #F7F4F2; max-width: 868px; width:100%; margin:0 auto;}
      ...
      #widget .bot .bubble{
        ...
        font-size: var(--Typography-font-l, 22px);
        font-style: normal;
        font-weight: 400;
        line-height: 130%;
      }
      ...
      #widget .composer{
        ...
        padding: 20px; border-radius: 16px; border-bottom-right-radius: 0; margin-bottom: 30px;
         max-width: 868px; width:100%; margin:0 auto;
      }
      #widget .input{
